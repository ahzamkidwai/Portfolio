...
export const projects: ProjectEntry[] = [
  ...
  {
    id: "modern-real-estate-marketplace",
    name: "Modern-Real-Estate-Marketplace",
    displayName: "Modern Real Estate Marketplace",
    description:
      "A full-stack real estate marketplace application with a modern frontend and backend.",
    category: "Full-Stack",
    featured: false,
    githubUrl: "https://github.com/ahzamkidwai/Modern-Real-Estate-Marketplace",
    technologies: ["JavaScript"],
    keyFeatures: ["Full-stack marketplace covering both frontend and backend components"],
    metrics: ["3 GitHub stars", "1 fork"],
    source: "github",
  },
];
